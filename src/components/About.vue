<template>
  <div class="main container">
    ...
    <div class="content" v-html="infoMarked"></div>
...
> 6. 掌握基本的数据分析、NLP技能。具有小规模的人工智能系统（广告识别）的研发和部署经验。
#### 联系方式:
...
- 独立研发了 **基于NLP的网站广告内容识别系统** （对 发送内容分词 Embedding、用户行为包含用户质量、使用方式、聊天频次、聊天时长、基础信息等建模）成功上线并有93%以上的广告识别准确度。
